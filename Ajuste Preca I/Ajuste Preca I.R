...
################################################################################
#     Selecci?n de covariables que se usan y eliminando Na
################################################################################
#----
...
predic<-predic %>% filter(status > 0) # Utilizando solamente los datos que no est?n censurados
...
################################################################################
#              Matriz de confusi?n con probabilidad predicha
################################################################################
prob
...
################################################################################
#             Matriz de confusi?n con probabilidad P(y<2)
################################################################################
...
confusionMatrix(as.factor(preds.zero),as.factor(obs.zero))
################################################################################
#             Matriz de confusi?n con media predicha
################################################################################
U.corte<-0.8
